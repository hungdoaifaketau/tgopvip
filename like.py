...
def nghigiailao(o):
    while o > 0:
        o -= 1
        print(f"\033[38;5;99m█ [Thầy Kiệt][Vui Lòng Chờ][{o} Giây]", end='\r')
        sleep(1 / 5)
        print(f"\x1b[38;5;226m█ [Thầy Kiệt][Vui Lòng Chờ][{o} Giây]", end='\r')
        sleep(1 / 5)
        print(f"\x1b[38;5;207m█ [Thầy Kiệt][Vui Lòng Chờ][{o} Giây]", end='\r')
        sleep(1 / 5)
