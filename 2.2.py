...
print(f'\033[1;34m  █ \033[1;33mBản Quyền Tool Thuộc:\033[1;31m mhungxcode')
time.sleep(0.50)
print(f'\033[1;34m  █ \033[1;31mLƯU Ý:\033[1;33m Tool Này Sẽ Random Từ \033[1;31m0-10 Follow \033[1;33mCho Mỗi Lần Chờ ')
time.sleep(0.50)
username=input('\033[1;34m  █ \033[1;37mNhập UID Tik Tok (Không Nhập @):\033[1;31m ')
while True:
    ...
    try:
        ...
        if search['success']==True:
            ...
            if send_follow['o']=='Success!' and send_follow['success']==True and send_follow['type']=='success':
                print('\033[1;34m  █ \033[1;32mTăng Follow Tik Tok Thành Công')
                continue
                ...
                try:
                    ...
                    for i in range(giay, 0, -1):
                        print(f'\033[34m  █\033[1;35m mhungxcode\033[34m █ \033[1;32mVui Lòng Chờ:\033[1;31m {i} \033[1;32mGiây', end='\r')
                        time.sleep(1)
                    continue
                except:
