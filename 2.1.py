...
class Zefoy:
    ...
    def send_captcha(self, new_session = False):
        if new_session: 
            ...
            time.sleep(2)
        if self.get_captcha(): 
            print('\033[1;34m  █\033[1;32m Đã Chạy Thành Công Tool Buff Tik Tok By:\033[1;31m mhungxcode\033[1;37m')
    ...
    def get_table(self, i = 1):
        ...
        for service in self.services:
            ...
            i += 1
        table.title = f"{Fore.WHITE} TOOL By: mhungxcode: {len([x for x in self.services_status if self.services_status[x]])}{Fore.RESET}"
        print(table)
        ...
        while True:
            ...
            if 'Session expired. Please re-login' in self.video_info:
                ...
                while time.time()-2<_+zefoy:
                    t-=1
                    print('\033[34m  █\033[1;35m mhungxcode\033[34m █ \033[1;32mVui Lòng Chờ: \033[1;31m{0}\033[32m '.format(t)+'Giây\033[1;32m',end='\r')
                    time.sleep(1)
                continue
