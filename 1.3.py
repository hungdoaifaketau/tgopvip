...
def idelay(o):
    while(o>0):
        o=o-1
        print(f"{trang}[{xanhnhat}mhungxcode{trang}] \033[1;33mD\033[1;34me\033[1;35ml\033[1;32ma\033[1;33my\033{trang}[\033[1;35m.....""]""["+str(o)+"]""    ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}mhungxcode{trang}] \033[1;31mD\033[1;32me\033[1;33ml\033[1;34ma\033[1;35my\033{trang}....""]"f"{trang}[{xanhnhat}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}mhungxcode{trang}] \033[1;32mD\033[1;33me\033[1;34ml\033[1;35ma\033[1;36my\033{trang}...""]"f"{trang}[{xanh_la}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}mhungxcode{trang}] \033[1;31mD\033[1;33me\033[1;35ml\033[1;33ma\033[1;31my\033{trang}..""]"f"{trang}[{do}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}mhungxcode{trang}] \033[1;32mD\033[1;34me\033[1;36ml\033[1;32ma\033[1;34my\033{trang}.""]"f"{trang}[{tim}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(1/6)
        print(f"{trang}[{xanhnhat}mhungxcode{trang}] \033[1;31mD\033[1;34me\033[1;36ml\033[1;32ma\033[1;34my\033{trang}""]"f"{trang}[{vang}"+str(o)+f"{trang}]""     ",end='\r')
        time.sleep(0.1)
        print(f"{trang}[{xanhnhat}mhungxcode{trang}] \033[1;31mD\033[1;34me\033[1;36ml\033[1;32ma\033[1;34my{trang}[\033[1;33m•••••{trang}""]"f"{trang}[{xanh_la}"+str(o)+f"{trang}]""     ",end='\r')
